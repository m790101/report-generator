...
const defaultData2: any = {
  ...
  PT: { title: '', value: '', units: '', resultNote: '', criteria: '', index: 53 },
  APTT: { title: '', value: '', units: '', resultNote: '', criteria: '', index: 54 },
  INR: { title: '', value: '', units: '', resultNote: '', criteria: '', index: 55 },
